...
dependencies {
    ...
    // The bote trait library supplies the protocol/topic/key traits used below.
    // On the runtime classpath so the produced model jar validates standalone.
    implementation(project(":"))

    // The AsyncAPI generator plugin — placing it on the build classpath makes
    // the "asyncapi" smithy-build plugin discoverable.
    add("smithyBuild", project(":asyncapi"))
}
